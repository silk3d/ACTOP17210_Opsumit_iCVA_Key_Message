        ...
        function($stateProvider, $urlRouterProvider, $logProvider, LOGGING_ENABLED, $locationProvider) {
            ...
            */
            ...
            $stateProvider
                ...
                controller: ['$rootScope', '$scope', '$state', 'HotspotsManager', '$log', 'VeevaMessaging',
                    function($rootScope, $scope, $state, HotspotsManager, $log, VeevaMessaging) {
                        ...
                        /********  gesture code begin ******/
                                    ...
                                    VeevaMessaging.sendMessage("viewTemplate.home");
