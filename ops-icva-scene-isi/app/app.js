...
angular.module('Messaging', [])
    .factory('VeevaMessaging', ['$http','$rootScope', '$state', "$log", 'KEY_MESSAGE_ID', function($http, $rootScope, $state, $log, KEY_MESSAGE_ID){
...
.run(
    ['$rootScope', '$state', '$stateParams', '$localStorage', 'HotspotsManager', 'VeevaMessaging', '$log', 'APP_VERSION', '$localStorage', 'KEY_MESSAGE_ID', 'InputManager',
        function($rootScope, $state, $stateParams, $localStorage, HotspotsManager, VeevaMessaging, $log, APP_VERSION, $localStorage, KEY_MESSAGE_ID, InputManager ) {
        ...
        function($stateProvider, $urlRouterProvider, $logProvider, LOGGING_ENABLED, $locationProvider) {
            ...
            */
            ...
            $stateProvider
                ...
                controller: ['$rootScope', '$scope', '$state', 'HotspotsManager', '$log', 'VeevaMessaging', '$localStorage', 'KEY_MESSAGE_ID',
                    function($rootScope, $scope, $state, HotspotsManager, $log, VeevaMessaging, $localStorage, KEY_MESSAGE_ID) {
                        $rootScope.hideProgress = true;    //  EDIT ME for the home controller.  First view displayed.  Associated with the home.html view.
                        $rootScope.hideHeader = true;

						$rootScope.lastKeyMessage = $localStorage.lastKeyMessage;   
						console.log("Global isi loaded KM: " + KEY_MESSAGE_ID );                     
                        $localStorage.lastKeyMessage = KEY_MESSAGE_ID;	
